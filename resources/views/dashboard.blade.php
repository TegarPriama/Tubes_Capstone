    ...
    <nav class="bg-green-700 text-white shadow-lg">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h1 class="text-xl font-bold">Smart Tani Greenhouse</h1>
                    <p class="text-xs text-green-200">Desa Kedung Dalem - Monitoring System</p>
                </div>
            </div>
            <div class="hidden md:flex space-x-6">
                <a href="{{ route('dashboard') }}" class="hover:text-green-200 font-semibold">Dashboard</a>
                <a href="#" class="hover:text-green-200">Laporan</a>
                <a href="#" class="hover:text-green-200">Kontrol Alat</a>
            </div>
        </div>
    </nav>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-12">
            <div class="bg-gray-50 px-6 py-4 border-b flex justify-between items-center">
                <h3 class="font-bold text-gray-700">
                    <i class="fa-solid fa-clipboard-list mr-2"></i> Jurnal Kegiatan Petani
                </h3>
